...
(function (global) {
  ...
  const FR_RULES = {
    ...
    pron: [
      ...
      rule(function (p) { return p.indexOf("lequel") >= 0 || p.indexOf("auquel") >= 0 || p.indexOf("duquel") >= 0 || p.indexOf("compose") >= 0; }, "rel_que"),
      rule(function (p) { return p.indexOf("ou") >= 0 && p.indexOf("lequel") < 0 && p.indexOf("auquel") < 0 && p.indexOf("duquel") < 0; }, "pron_relatif_ou"),
      rule(function (p) { return p.indexOf("demonstratif") >= 0; }, "adj_demonstratifs"),
